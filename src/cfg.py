...
# 训练和应用版本
extractor.add_argument('--istrigger', action="store_true",default=True) # True: trigger + argument方式; False: ET + text -> argument方式
...
extractor.add_argument('--do_train_trigger', action="store_true",default=False)
