...
train_path = "data/military/train.json"
test_path = "data/military/dev.json"
output_path = "data/military/"
all_path = 'data/military/all_data_processed.jsonl'
path_list = [all_path]
